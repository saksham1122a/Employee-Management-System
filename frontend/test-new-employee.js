// Test employee signup with new email and debugging
console.log('🔍 Testing employee signup with new email...');

const testNewEmployee = async () => {
  try {
    ...
    if (signupResponse.ok) {
      ...
      if (loginResponse.ok) {
        ...
        if (employeesResponse.ok) {
          ...
          console.log('🎉 New employee test completed!');
